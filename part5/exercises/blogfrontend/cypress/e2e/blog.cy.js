describe('Blog App', function() {
  ...
  describe('When logged in', function() {
    ...
    it('Blogs are sorted by likes', function() {
      cy.createBlog({ title: 'test blog 1', author: 'test author', url: 'test url' })
      cy.createBlog({ title: 'test blog 2', author: 'test author', url: 'test url' })
      cy.createBlog({ title: 'test blog 3', author: 'test author', url: 'test url' })
